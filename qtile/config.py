# As much as I love the copyright stuff and all that, I do love saving some
# screen space. So, thanks everyone who worked on this!
...
def really_quit():
    """Instead of quitting qtile, spawns a box asking if you'd actually like to quit
    click it again to actually exit"""

    # spawn a prompt using lazy.spawncmd() with the prompt using a click_callback() (must be done in the widget itself below)
        ...
        Screen(
            top=bar.Bar(
                [
                    ...
                    widget.Prompt(background = colors['gray']),
